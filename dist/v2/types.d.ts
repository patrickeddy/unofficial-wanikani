...
export interface WaniKaniResource<T extends WaniKaniDataType> extends WaniKaniResourceResponse<T> {
    data: T;
}
export interface WaniKaniCollection<T extends WaniKaniDataType> extends WaniKaniResourceResponse<T> {
    data: T[];
}
